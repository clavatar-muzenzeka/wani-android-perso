 ...
 */
public class CompactEncaissement extends SugarRecord implements Parcelable {
    ...
    CompactUser idEncaisser;

    public CompactEncaissement() {
    }
    ...
    public CompactUser getIdEncaisser() {
        return idEncaisser;
    }

    public void setIdEncaisser(CompactUser idEncaisser) {
        this.idEncaisser = idEncaisser;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeParcelable(this.idEncaisser, flags);
    }

    protected CompactEncaissement(Parcel in) {
        ...
        this.idEncaisser = in.readParcelable(CompactUser.class.getClassLoader());
    }

    public static final Creator<CompactEncaissement> CREATOR = new Creator<CompactEncaissement>() {
        @Override
        public CompactEncaissement createFromParcel(Parcel source) {
            return new CompactEncaissement(source);
        }

        @Override
        public CompactEncaissement[] newArray(int size) {
            return new CompactEncaissement[size];
        }
    };
}